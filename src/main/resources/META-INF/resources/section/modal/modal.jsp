...
<div id="myModal-cuervo-marcas" class="modal-cuervo-marcas">
	<div class="modal-content-cuervo-marcas">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="row" class="pd-md">
						<div class="col-md-12">
							<h5 class="yellow inLine" style="margin-top: 1.7rem;">Registro de vacaciones</h5> <span class="close-cuervo-marcas" style="color: #CCB874">&times;</span>
						</div>
						<div class="col-md-12">
						<!-- Contenido -->
